...
if __name__ == '__main__':
    ...
    task_name = 'ANIMSEG_CoarsePoints_DecoderOnly_REAL7k' # finetuned checkpoint will be saved here
    ...
    epoch_start = 0 # dont change this while resuming training, change the one beloww
    if resume_training:
        epoch_start = 10 # change this
        resume_ckpt = join(ckpt_dir, 'ANIMSEG_CoarsePoints_DecoderOnly_REAL7k/model_eval_best.pth')
    ...
    crop_size = (800, 800)
    randomaug = RandomAug(target_size=input_size, crop_size=crop_size, rotate_max_angle=360)
