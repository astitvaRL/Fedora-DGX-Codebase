...
if __name__ == '__main__':
    ...
    exp_eval_results_dir = "/mnt/users_scratch/astitva/WORKSPACE/Fedora-DGX-Codebase/SEGMENTATION/SAM_finetuning/EVALUATION/eval_16k_E2E_FULL/499/499/"

    ref_dir = join(data_root, label_id_dir_name)
    files = sorted(os.listdir(ref_dir))[-50:]
