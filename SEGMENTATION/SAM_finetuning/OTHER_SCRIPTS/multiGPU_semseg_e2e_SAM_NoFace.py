...
if __name__ == '__main__':
    ...
    task_name = 'ANIMSEG_E2E_NoFace_NoBinmask_REAL7k' # finetuned checkpoint will be saved here
    ...
    if resume_training:
        ...
        resume_ckpt = join(ckpt_dir, 'ANIMSEG_E2E_NoFace_NoBinmask_REAL7k/model_eval_best.pth')
