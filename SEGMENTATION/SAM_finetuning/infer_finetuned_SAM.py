...
from utils.SemanticSegmentation import SemanticSegmentation, SemanticSegmentationTernary, SemanticSegmentationCoarse, SemanticSegmentationFace
join = os.path.join
...
if __name__ == '__main__':
    ...
    # EXPERIMENT CONFIG
    task_name = 'ANIMSEG_EncDec_Coarse_REAL7k'
    ...
    os.makedirs(join(model_load_path, 'inference'), exist_ok=True)
    ...
    print(f"INFERENCE CACHE READY! --- Cache Size:", test_dataset.cache.shape)
    ...
    eval_epoch_dir = join(model_load_path, f"inference/{epoch}")
    if load_best_eval_ckpt:
        eval_epoch_dir = join(model_load_path, f"inference/best_eval")
