...
if __name__ == '__main__':
    ...
    task_name = 'ANIMSEG_E2E_Strokes2Coarse_randomrot' # finetuned checkpoint will be saved here
    ...
    if resume_training:
        ...
        resume_ckpt = join(ckpt_dir, 'ANIMSEG_E2E_Strokes2Coarse/model_eval_best.pth')
