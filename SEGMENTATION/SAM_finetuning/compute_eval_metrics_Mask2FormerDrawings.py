...
if __name__ == '__main__':
    ...
    exp_eval_results_dir = "/mnt/users_scratch/astitva/WORKSPACE/Fedora-DGX-Codebase/SEGMENTATION/SAM_finetuning/EVALUATION/eval_16k_E2E_FULL/best_eval/"
    ...
    mask2forer_eval_results_dir = '/mnt/users_scratch/astitva/WORKSPACE/Fedora-DGX-Codebase/SEGMENTATION/MaskFormer/Mask2Former/demo/results/EVAL_DRAWINGS_16k/'
    ...
    for filename in tqdm(files):
        if filename.endswith('.png'):
            ...
            exp_seg = cv2.imread(join(mask2forer_eval_results_dir, f'{filename[:-4]}_seg.png'))
