...
if __name__ == '__main__':
    ...
    # create dataset
    train_dataset = DrawingsDataset(sam_model, labels_definition_file_path=labels_definition_file_path, data_root = data_root, img_dir_name=image_dir_name, label_id_dir_name = label_id_dir_name, mode='train', sample_size=int((16-train_split_size_k)*1000))
