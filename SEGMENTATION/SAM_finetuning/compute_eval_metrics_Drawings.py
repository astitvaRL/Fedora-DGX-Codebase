...
if __name__ == '__main__':
    ...
    exp_eval_results_dir = '/mnt/users_scratch/astitva/WORKSPACE/Fedora-DGX-Codebase/SEGMENTATION/SAM_finetuning/EVALUATION/eval_data_split_0.5k/best/best_eval/'
    ...
    for filename in tqdm(files):
        if filename.endswith('.png'):
            ...
            exp_seg = cv2.imread(join(exp_eval_results_dir, f'{filename_base}/pred_all.png'))
