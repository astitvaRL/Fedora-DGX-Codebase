...
if __name__ == '__main__':
    ...
    # ckpt_dir = './checkpoints/ckpt_jesse'
    ...
    cache_dir = join(data_root, 'dataset_caches/cache_TEST_SPLIT_0.5k')
    ...
    out_dir = f'EVALUATION/eval_data_split_{train_split_k}k/best/'
    mode = 'test'
    BATCH_SIZE = 1
    ...
    # init_checkpoint_coarse = join(ckpt_coarse_dir, f'{task_name_coarse}/model_eval_best.pth')
    ...
    if not load_best_eval_ckpt:
        init_checkpoint_coarse = join(ckpt_coarse_dir, f'{task_name_coarse}/{all_ckpts_dir}/model_{epoch_coarse}.pth')
    ...
    # create dataset
    test_dataset = DrawingsDatasetC2FAll(sam_model, labels_definition_file_path=labels_definition_file_path, data_root = data_root, img_dir_name=image_dir_name, label_id_dir_name = label_id_dir_name, mode=mode, sample_size=2000)
