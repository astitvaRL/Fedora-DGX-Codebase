...
if __name__ == '__main__':
    ...
    task_name = 'semsegUP_EncDec_FaceOnly_REAL7k' # finetuned checkpoint will be saved here
    ...
    if resume_training:
        ...
        resume_ckpt = join(ckpt_dir, 'semsegUP_DecoderOnly_FaceOnly_REAL7k/model_eval_best.pth')
