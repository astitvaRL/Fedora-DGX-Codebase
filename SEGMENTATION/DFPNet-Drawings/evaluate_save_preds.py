...
COLORS = [[0, 0, 0], [177, 25, 217], [68, 121, 228], [21, 28, 56], [63, 128, 243], [171, 69, 206], [12, 87, 48], [245, 66, 108], [125, 172, 35], [117, 209, 198], [149, 218, 110], [169, 185, 239], [71, 196, 14], [160, 234, 179], [16, 162, 174], [247, 181, 62], [187, 108, 168], [121, 28, 75], [86, 162, 11], [240, 55, 58], [197, 206, 105], [245, 124, 15], [245, 22, 161], [154, 131, 193], [15, 77, 174], [21, 176, 108], [255, 255, 255]]
...
def main():
    ...
    state_dict_loaded = torch.load(restore_from)

    for key in state_dict_loaded.keys():
        state_dict[key[7:]] = deepcopy(state_dict_loaded[key])
