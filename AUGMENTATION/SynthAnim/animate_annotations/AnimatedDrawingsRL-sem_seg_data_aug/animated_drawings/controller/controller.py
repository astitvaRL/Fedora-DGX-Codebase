...
class Controller():
    ...
    def create_controller(controller_cfg: ControllerConfig, scene: Scene, view: View) -> Controller:
        ...
        elif controller_cfg.mode == 'export':
            from animated_drawings.controller.export_controller import ExportController
            return ExportController(controller_cfg, scene, view)
        elif controller_cfg.mode == 'streaming':
            from animated_drawings.controller.streaming_controller import StreamingController
            return StreamingController(controller_cfg, scene, view)
        elif controller_cfg.mode == 'image_render':
            from animated_drawings.controller.image_render_controller import ImagesRenderController
            return ImagesRenderController(controller_cfg, scene, view)
        else:
