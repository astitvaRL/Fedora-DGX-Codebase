...
import numpy as np
from animated_drawings.model.arap import ARAP_Igarashi  # , plot_mesh
...
def test_single_triangle_mesh():
    ...
    arap = ARAP_Igarashi(vertices=vertices, triangles=triangles, pins_xy=pins_xy)
...
def test_two_triangle_mesh():
    ...
    new = ARAP_Igarashi(vertices=vertices, triangles=triangles, pins_xy=pins_xy)
    if show_plots:
        pass
        # plot_mesh(vertices, triangles, pins_xy)
