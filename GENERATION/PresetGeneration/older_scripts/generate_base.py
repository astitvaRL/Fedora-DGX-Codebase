...
output_root = f"OUTPUT/output_BASE"
...
for label_name in tqdm(labels):
    ...
    cv2.imwrite(join(output_dir,f'{label_name.split("_")[0]}_base_face.png'), cv2.cvtColor(img_face, cv2.COLOR_RGB2BGR))
    cv2.imwrite(join(output_dir,f'{label_name.split("_")[0]}_no_mouth_face.png'), cv2.cvtColor(img_face_no_mouth, cv2.COLOR_RGB2BGR))
    cv2.imwrite(join(output_dir,f'{label_name.split("_")[0]}_no_eyes_face.png'), cv2.cvtColor(img_face_no_eyes, cv2.COLOR_RGB2BGR))
    cv2.imwrite(join(output_dir,f'{label_name.split("_")[0]}_base.png'), cv2.cvtColor(img_base, cv2.COLOR_RGB2BGR))
    cv2.imwrite(join(output_dir,f'{label_name.split("_")[0]}_no_mouth.png'), cv2.cvtColor(img_no_mouth, cv2.COLOR_RGB2BGR))
    cv2.imwrite(join(output_dir,f'{label_name.split("_")[0]}_no_eyes.png'), cv2.cvtColor(img_no_eyes, cv2.COLOR_RGB2BGR))
