class PresetConfig:
    def __init__(self, class_name):
        ...
        if self.config['class_name'] == 'mouth':
            ...
            self.config['prompts'] = ['with an open mouth', 'with mouth wide open',  'frowning', 'with tongue out', 'with vampire teeth']
        ...
        if self.config['class_name'] == 'eyes':
            ...
            self.config['prompts'] = ['with dark pupils looking left', 'with big shiny dark eyes', 'with pupils looking up',  'with eyes slightly closed', 'with happy eyes', 'with eyes closed']
