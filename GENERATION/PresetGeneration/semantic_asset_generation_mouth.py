...
for file_name in tqdm(images):
    ...
    cv2.imwrite(f'{output_dir_metadata}/inpainted_mouth_only.png', bgr_conversion(np.array(base_image)))
    cv2.imwrite(f'{output_dir_metadata}/inpainted_face_mouth_only.png', bgr_conversion(base_image_cropped))
